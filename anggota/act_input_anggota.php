...
$sql = "INSERT INTO `data_anggota` (`id`, `no_induk`, `nama`, `jk`, `kelas`, `ttl`, `alamat`, `imageId`, `imageType`, `imageData`) VALUES (NULL, '', '$nama', '$jk', '$kelas', '$ttl', '$alamat', '{$imageProperties['mime']}', '{$imageProperties['mime']}', '{$imgData}')";
