...
<tr><td class="head-data" colspan="2">Input Examplar Untuk Judul Buku : <?php echo $jdl; ?></td></tr>
...
<td class="pinggir-data"><input type="text" size="40" name="asal" value="<?php echo $cNumber; ?>"></td></tr>
